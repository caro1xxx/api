...
import { servers } from "../api/user";
import { useRequest } from "ahooks";
import { Server } from "../types/state";

const Wrap = styled.div`
  background-image: url("https://pic.imgdb.cn/item/65a75106871b83018a62931d.png");
...
const Status = (props: Props) => {
  const { data, loading } = useRequest(servers, {
    cacheKey: "servers",
  });
          ...
          data.map((item: Server) => {
            return (
              <div key={item.pk} className="item">
                ...
                <div>{item.fields.load > 10 ? <span className="error"></span> : <span className="success"></span>}</div>
